...
#from nets.AttUnet import U_Net as Unet 
#from nets.UNet2Plus import UnetPlusPlus as Unet
#from nets.UNet3Plus import UNet3Plus as Unet
#from nets.AttUnet import AttU_Net as Unet
#from nets.AttUnet import R2AttU_Net as Unet
#from nets.AttUnet import R2U_Net as Unet
#使用SwinUnet/TransUnet时，需要将输入图片的大小调整为512*512并适当调大学习率
#from nets.SwinUnet import SwinUnet as Unet
#在SwinUnet.py中window_size=8适应512x512输入、window_size=16适应1024x1024输入
#在vit_seg_configs.py中config.patches.grid = (32, 32)  # 修改为(32,32)以适应512x512输入 TransUnet.py img_size=512
#在vit_seg_configs.py中config.patches.grid = (64, 64)  # 修改为(64,64)以适应512x512输入 TransUnet.py img_size=1024
#from nets.TransUnet import TransUnet as Unet
#from nets.ResUnet import ResUnet as Unet
#from nets.ResUnet import ResUnet2Plus as Unet
from nets.ConvNeXt.ConvNeXtUnet import ConvNeXtUnet as Unet
#from nets.DenseUnet import Dense_Unet as Unet
#from nets.vision_mamba import MambaUnet as Unet
#from nets.vmunet import VMUNet as Unet
...
if __name__ == "__main__":
    ...
    if model_path != '':
        ...
        device = torch.device("cpu")  # 确保device正确设置 
